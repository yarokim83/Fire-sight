...
const APP_VERSION = 'v3.3.0'; // 안티그래비티 이관
const CLIENT_ID = import.meta.env.VITE_GOOGLE_CLIENT_ID;
const SCOPES = 'https://www.googleapis.com/auth/drive.readonly https://www.googleapis.com/auth/drive.file https://www.googleapis.com/auth/spreadsheets.readonly';
...
function App() {
  ...
  const renderContent = () => {
    switch (mode) {
      ...
      case 'study-manager': return <StudyManager accessToken={accessToken} tokenClient={tokenClient} isAuthenticated={isAuthenticated} />;
      case 'visual':
